...
void Move(bool detectNonDirectionalInput = false, int optionalMovementSpeed = 3) 
{
    int lastX = playerX;
    int lastY = playerY;
    ...
    switch (Console.ReadKey(true).Key) 
    {
		...
		case ConsoleKey.Escape:     
            ...
            break;
        default:
            detectNonDirectionalInput = true;
            break;
    }
