...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            string[] animalsArray = new string[] { };

            while (dogCharacteristic == "")
            {
                // #2 have user enter multiple comma separated characteristics to search for
                Console.WriteLine($"\r\nEnter one desired dog characteristic to search for (separated by commas)");
                readResult = Console.ReadLine();
                if (readResult != null)
                {
                    dogCharacteristic = readResult.ToLower().Trim();
                    animalsArray = dogCharacteristic.Split(", ");
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    for (int j = 2; j > -1; j--)
                    {
                        ...
                        {
                            Console.Write($"\rsearching our dog {ourAnimals[i, 3]} for {dogCharacteristic} {icon} {j.ToString()}");
                            Thread.Sleep(100);
                        }
                    ...
                    foreach (var characteristic in animalsArray)
                    {
